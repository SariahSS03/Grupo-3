...
<body class="body-menu">
  <nav>
    <div class="menu">
      <img class="img" src="/grupo-3/Proyecto3.1/Imagenes/logo.png" width="150px"  height="auto";>
      ...
      <!-- Enlaces -->
      <ul>
        <li><a href="/grupo-3/Proyecto3.1/Presentacion/Presentacion.php">INICIO</a></li>
       ...
       <li>
        ...
        <li><a href="comenestilo.php">COMENTARIOS</a></li>
         <li><a href="/grupo-3/Proyecto3.1/Estudiante/iniciarsesion.php">INICIO DE SESION</a></li>
      </ul>
    </div>
  </nav>
