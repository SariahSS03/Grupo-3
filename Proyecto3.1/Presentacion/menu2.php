...
<body>
    <footer class="final" id="contacto">
      <div id="espacios">
            <div >
            <img src="/grupo-3/Proyecto3.1/Imagenes/logo.png" width="230px"  height="auto";>
            </div>
            <div>
      ...
      <div id="espacios">
            <div>
            <img class="img3" src="/grupo-3/Proyecto3.1/Imagenes/casita.png" width="40px"  height="auto";> 
            </div>
            <div>
      ...
      <div id="espacios">
            <div>
            <img class="img3" src="/grupo-3/Proyecto3.1/Imagenes/telefono.png" width="40px"  height="auto";>
            <strong>Location</strong><br>
            Av.  Ayacucho N° 0129 entre las calles Punata y Agustín López, frente a la terminal de buses.
            </div>
            <button id="iniciosesion" onclick="location.href='/grupo-3/Proyecto3.1/Estudiante/iniciarsesion.php'">
